...
namespace CP2.API.Presentation.Controllers
{
    ...
    public class FornecedorController : ControllerBase
    {
        ...
        // Método GET por ID para retornar um fornecedor específico
        [HttpGet("{id}")]
        ...
        // Método PUT para editar um fornecedor existente
        [HttpPut("{id}")]
        [ProducesResponseType(typeof(FornecedorEntity), (int)HttpStatusCode.OK)]
        [ProducesResponseType((int)HttpStatusCode.BadRequest)]
        ...
        // Método DELETE para excluir um fornecedor existente
        [HttpDelete("{id}")]
        [ProducesResponseType(typeof(FornecedorEntity), (int)HttpStatusCode.OK)]
        [ProducesResponseType((int)HttpStatusCode.BadRequest)]
