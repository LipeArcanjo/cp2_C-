...
namespace CP2.API.Presentation.Controllers
{
    ...
    public class VendedorController : ControllerBase
    {
        ...
        // Método GET para listar todos os vendedores
        [HttpGet]
        ...
        // Método GET por ID para retornar um vendedor específico
        [HttpGet("{id}")]
        ...
        // Método POST para criar um novo vendedor
        [HttpPost]
        ...
        // Método PUT para editar um vendedor existente
        [HttpPut("{id}")]
        [ProducesResponseType(typeof(VendedorEntity), (int)HttpStatusCode.OK)]
        [ProducesResponseType((int)HttpStatusCode.BadRequest)]
        ...
        // Método DELETE para excluir um vendedor existente
        [HttpDelete("{id}")]
        [ProducesResponseType(typeof(VendedorEntity), (int)HttpStatusCode.OK)]
        [ProducesResponseType((int)HttpStatusCode.BadRequest)]
